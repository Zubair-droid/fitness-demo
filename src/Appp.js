...
// ==========================================
const config = {
  trainerName: "Us", // Change this to the lead's name
  tagline: "AALMIGHTY FITNESS STUDIO", // Change location
    ...
    <div className="min-h-screen bg-slate-950 text-white font-sans selection:bg-yellow-500 selection:text-black">
      ...
      <div className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto mt-[-50px]">
          <h3 className={`font-bold tracking-[0.2em] mb-4 ${config.accentColor} uppercase animate-fade-in-up`}>
            {config.tagline}
          </h3>
